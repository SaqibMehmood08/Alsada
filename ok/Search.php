...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Hanyu International study"and Exam Center  />
	<!-- OG -->
	<meta property="og:title" content="Hanyu International study"and Exam Center  />
	<meta property="og:description" content="Hanyu International study"and Exam Center  />
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo" >
						<a href="index.php"><img src="assets/images/chines.png" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
...
$name=$row['video'];
echo "<h5>you are wathing:".$name. "</h5>";

			
?>
<a href="blog-details?id=<?php echo $A['id'];?>"></a>
<h5 class="post-title"> </h5>
<!-- tITLE End; -->
<video  controls autoplay autobuffer="on" width="100%";  >
<source src="admin/video/<?php echo $name;?>" type="video/mp4">
</video>

									
									<div class="post-extra">
										<a href="blog-details.php?id=<?php echo $A['id'];?>" class="btn-link"></a>

										<a href="blog-details.php?id=<?php echo $A['id'];?>" class="comments-bx"><i class="fa fa-comments-o"></i></a>
									</div>
...
{
$word = $_GET['search'];
$q= "SELECT * FROM video WHERE title LIKE '%$word%' LIMIT $result, $post_per_page  ";
}
else
{
  $q= "SELECT * FROM video" ;
    ...
    <div class="col-lg-4 sticky-top">
     <aside class="side-bar sticky-top">  
        ...
        <div class="card mb-3">
         ...
         <form class="form-inline" role="search"  action="index.php" method="" >


       <input class="form-control mr-sm-2" type="search" name="search" placeholder="Search"  aria-label="Search">
       
   
 <button class="btn btn-outline-success my-2 my-sm-0"             name="search" type="search" >Search</button>
		...
		<div class="ttr-post-media"> </div>						<div class="ttr-post-info">
			<div class="ttr-post-header">

	<h6 class="post-title">
	<a href="blog-details.php"><?php echo $A['title'];?></a></h6>
						<ul class="media-post">
        ...
        <div class="footer-top">
        	<div class="container">
					<div class="pt-logo mr-auto">
						...
						<a href="index.php"><img src="assets/images/chines.png"style="width: 100px; " alt="post-image"></a>
						</div>
								...
								<form class="subscription-form" action="http://educhamp.themetrades.com/demo/assets/script/mailchamp.php" >
									...
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button name="search" value="search" type="search" class="btn"><i class="fa fa-arrow-right"></i></button>
										</span> 
									</div>
								</form>
							</div>
