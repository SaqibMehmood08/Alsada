...
<div id="loading-icon-bx"></div>
    ...
    <?php 
           ...
           $postquery ="SELECT * FROM data WHERE id=$post_id";

           $run =mysqli_query($con,$postquery);
           $post=mysqli_fetch_assoc($run);
     $imageURL = 'Admin/uploads/'.$post["image"];
          ?>          
    <!-- header END ==== -->
    <!-- Content -->
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url(<?php  echo $imageURL;?>);">
            <div class="container">
										...
										<ol class="comment-list">
											<li class="comment">
												<div class="comment-body">
													...
													<div class="comment-meta"> <a href="#"></a> </div>
													<p> </p>
