  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="ind.php">Search</a> 
        <a class="nav-link" href="customer.php">Measure</a>
        <a class="nav-link" href="post.php">Design</a>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $second_last = $total_no_of_pages - 1; // total page minus 1
   ...
   <tr>
        ...
        <td><a href="print_measure.php?id= <?php echo $row['id'];?>">Click</a></td>
          </tr>
          <?php      }
  mysqli_close($con);
    ?> 
